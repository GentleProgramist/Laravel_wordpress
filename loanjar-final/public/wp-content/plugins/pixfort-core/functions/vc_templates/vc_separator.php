 ...
 */
// $el_width = $style = $color = $border_width = $accent_color = $el_class = $el_id = $align = $css = '';
...
// 	$output = '';
// 	if(!empty($animation)){
// 		$output .= '<div class="animate-in" data-anim-type="'.$animation.'" data-anim-delay="'.$delay.'">';
// 	}
// 	$output .= $vc_text_separator->render( $atts );
// 	if(!empty($animation)){
// 		$output .= '</div>';
// 	}
// 	return $output;
