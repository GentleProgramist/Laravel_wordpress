...
<div class="ocdi  wrap  about-wrap">
	...
	<?php ob_start(); ?>
		<h1 class="ocdi__title "><?php esc_html_e( 'Essentials One Click Demo Import', 'pt-ocdi' ); ?></h1>
	<?php
	...
	<div class="ocdi__intro-notice  notice  notice-warning  is-dismissible">
		...
		<p>
			<?php esc_html_e( 'Note that it\'s recommended to import the demo content into a fresh WordPress installation to prevent an conflicts, if you want to reset you WordPress before importing the demo content you can check ', 'pt-ocdi' ); ?><a href="https://essentials.pixfort.com/knowledge-base/how-to-reset-your-wordpress" target="_blank">this article</a><?php esc_html_e( ' from our knowledge base.', 'pt-ocdi' ); ?>
		</p>
	</div>
	...
	if( class_exists( '\Elementor\Plugin' ) ) {
		...
		<div class="ocdi__intro-notice  notice  pixfort-admin-notice  is-dismissible">
			<div class="notice-text"><?php esc_html_e( 'It seems that you are using Elementor on your website! Please make sure to follow these steps before importing Elementor demo content.', 'pt-ocdi' ); ?></div>
