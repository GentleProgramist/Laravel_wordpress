...
Description: Import Essentials demo content, widgets and theme settings with one click.
Version: 2.6.2
Author: PixFort
Author URI: https://themeforest.net/user/PixFort
License: GPL3
...
define( 'PIXFORT_DEMO_VERSION', '2.6.2'  );
/**
