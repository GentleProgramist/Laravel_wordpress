...
<!--				<input type="hidden" name="istest" value="--><?//= SUBMIT_TEST_APPLICATIONS; ?><!--">-->
				...
				<!-- SOF: Form Section | Employment Details -->
				    <div class="form-group section-header">
					<div class="col-xs-12 text-center">
						<h3>4. Your employment details</h3>
					</div>
				</div>
                    <!-- incomeSource *-->
                    <div class="form-group">
                    ...
                    <div class="form-group hidden">
					<div class="col-md-3 col-md-offset-1 col-sm-8 col-sm-offset-2 md-text-left">
						<label for="employmentIndustry" class="control-label">Your Employment Industry<span class="text-danger">*</span></label>
					</div>
					<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
						<div class="btn-group" data-toggle="buttons" data-requiredif="employmentIndustryRequired">
							<label class="btn btn-default wrap" id="ConstructionManufacturing">
								<input type="radio" name="employmentIndustry" value="ConstructionManufacturing" > Construction<br />Manufacturing
							</label>
							<label class="btn btn-default" id="Military">
								<input type="radio" name="employmentIndustry" value="Military" > Military
							</label>
							<label class="btn btn-default" id="Health">
								<input type="radio" name="employmentIndustry" value="Health" > Health
							</label>
							<label class="btn btn-default wrap" id="BankingInsurance">
								<input type="radio" name="employmentIndustry" value="BankingInsurance" > Banking<br />Insurance
							</label>
							<label class="btn btn-default" id="Education">
								<input type="radio" name="employmentIndustry" value="Education" > Education
							</label>
							<label class="btn btn-default wrap" id="CivilService">
								<input type="radio" name="employmentIndustry" value="CivilService" > Civil<br />Service
							</label>
							<label class="btn btn-default wrap" id="SupermarketRetail">
								<input type="radio" name="employmentIndustry" value="SupermarketRetail" > Supermarket<br />Retail
							</label>
							<label class="btn btn-default wrap" id="UtilitiesTelecom">
								<input type="radio" name="employmentIndustry" value="UtilitiesTelecom" > Utilities<br />Telecom
							</label>
							<label class="btn btn-default wrap" id="HotelRestaurantAndLeisure">
								<input type="radio" name="employmentIndustry" value="HotelRestaurantAndLeisure" > Hotel, Restaurant<br />And Leisure
							</label>
							<label class="btn btn-default wrap" id="OtherOfficeBased">
								<input type="radio" name="employmentIndustry" value="OtherOfficeBased" > Other Office<br />Based
							</label>
							<label class="btn btn-default wrap" id="OtherNotOfficeBased">
								<input type="radio" name="employmentIndustry" value="OtherNotOfficeBased" > Other Not<br />Office Based
							</label>
							<label class="btn btn-default wrap" id="DrivingDelivery">
								<input type="radio" name="employmentIndustry" value="DrivingDelivery" > Driving<br />Delivery
							</label>
							<label class="btn btn-default wrap" id="AdministrationSecretarial">
								<input type="radio" name="employmentIndustry" value="AdministrationSecretarial" > Administration<br />Secretarial
							</label>
							<label class="btn btn-default wrap" id="MidLevelManagement">
								<input type="radio" name="employmentIndustry" value="MidLevelManagement" > Mid Level<br />Management
							</label>
							<label class="btn btn-default wrap" id="SeniorLevelManagement">
								<input type="radio" name="employmentIndustry" value="SeniorLevelManagement" > Senior Level<br />Management
							</label>
							<label class="btn btn-default wrap" id="SkilledTrade">
								<input type="radio" name="employmentIndustry" value="SkilledTrade" > Skilled<br />Trade
							</label>
							<label class="btn btn-default" id="Professional">
								<input type="radio" name="employmentIndustry" value="Professional" > Professional
							</label>
						</div>
					</div>
					<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
					...
					<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 input-container">
						<input type="text" name="jobTitle" id="jobTitle" value="" placeholder="Enter job title" class="form-control" />
					</div>
					<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
						<div class="hidden label label-danger" role="alert"></div>
					</div>
                    ...
                    <!-- monthlyIncome *-->
                    <div class="form-group">
					<div class="col-md-3 col-md-offset-1 col-sm-8 col-sm-offset-2 md-text-left" id="monthlyIncome" >
                    ...
                    <div class="form-group hidden">
					<div class="col-md-3 col-md-offset-1 col-sm-8 col-sm-offset-2 md-text-left">
						<label for="combined_pay" id="combined_pay" class="control-label">Total Monthly Household Income<span class="text-danger">*</span></label>
					</div>
					<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 input-container">
				...
				<!-- EOF: Form Section | Bank verification -->
                    ...
                    <div class="form-group section-header">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="checkbox" id="ccs">
							<label>
								<input type="checkbox" name="consentCreditSearch" id="consentCreditSearch" /> I agree that Amikaro Finance Ltd trusted 3rd party partners listed here, and those providing the category of services detailed in the Privacy Policy may contact me by phone(you can unsubscribe at any time).
							</label>
							<div class="hidden label label-danger" role="alert"></div>
						</div>
					</div>
                    ...
                    <div class="form-group section-header">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="checkbox" id="ctpe">
							<label>
								<input type="checkbox" name="consentThirdPartyEmails" id="consentThirdPartyEmails"/> I agree that Amikaro Finance Ltd trusted 3rd party partners listed here, and those providing the category of services detailed in the Privacy Policy may contact me by SMS or automated messages(you can unsubscribe at any time).
							</label>
							<div class="hidden label label-danger" role="alert"></div>
						</div>
					</div>
                    ...
                    <div class="form-group section-header">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="checkbox" id="ctps">
                                <label>
                                    <input type="checkbox" name="consentThirdPartySMS" id="consentThirdPartySMS"/> I agree that Amikaro Finance Ltd trusted 3rd party partners listed here, and those providing the category of services detailed in the Privacy Policy may contact me by SMS or automated messages(you can unsubscribe at any time).
                                </label>
                                <div class="hidden label label-danger" role="alert"></div>
                            </div>
                        </div>
                    ...
                    <div class="form-group section-header">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="checkbox" id="ctpp">
                                <label>
                                    <input type="checkbox" name="consentThirdPartyPhone" id="consentThirdPartyPhone"/> I agree that Amikaro Finance Ltd trusted 3rd party partners listed here, and those providing the category of services detailed in the Privacy Policy may contact me by SMS or automated messages(you can unsubscribe at any time).
                                </label>
                                <div class="hidden label label-danger" role="alert"></div>
                            </div>
                        </div>
