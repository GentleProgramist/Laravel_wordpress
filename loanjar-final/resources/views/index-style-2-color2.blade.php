...
<html lang="en">
  <head>
    <title>Tovo | Mobile App Landing HTML Templates</title>
    <meta charset="utf-8">
    ...
    <!-- color variation-->
    <link id="color" rel="stylesheet" href="../assets/css/color/color-2.css" media="screen">
  </head>
  <body class="home-style-two" data-spy="scroll" data-bs-target=".navbar" data-offset="80">
    <!-- Preloader-->
      ...
      <div class="container"><a class="navbar-brand" href="index.html"><img src="../assets/images/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse default-nav" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto" id="mymenu">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#blog" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">blog</a>
              <ul class="dropdown-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="blog-details-with-leftsidebar.html">details leftsidebar</a></li>
                <li class="nav-item"><a class="nav-link" href="blog-details-with-rightsidebar.html">details rightsidebar</a></li>
              </ul>
            </li>
            <li class="nav-item"><a class="nav-link" href="#price" data-menuanchor="price">price</a></li>
            <li class="nav-item"><a class="nav-link" href="#contact" data-menuanchor="contact">contact us</a></li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Other page</a>
              <ul class="dropdown-menu">
                <li class="nav-item"><a class="nav-link" href="apply.blade.php">sign in</a></li>
                <li class="nav-item"><a class="nav-link" href="sign-up.html">sign up</a></li>
                <li class="nav-item"><a class="nav-link" href="forget-pwd.html">Forget Password</a></li>
    ...
    <!-- Nav end-->
    <!-- Home Section start-->
    <section class="home home-two vertical-scrolling" id="home">
      <div class="container">
        <div class="row">
          <div class="col-md-5 col-sm-12 position-relative">
            <div class="home-contain">
              <div class="text-white">
                <div class="contain"><img src="../assets/images/home2/logo-icon.png" alt="logo">
                  <h4>Landing page for</h4>
                  <h1 class="text-white">t<span class="f-bold">o</span>v<span class="f-bold">o</span><span class="f-bold f-color text-white">app</span></h1>
                  <p class="slide-cap-desc">Enhance your business ideas with Powerful, Responsive, Elegant TOVO Theme.</p><a href="#"><img class="store" src="../assets/images/appstore.png" alt="appstore"></a><a href="#"><img class="ms-10 store" src="../assets/images/play-store.png" alt="play-store"></a>
                </div>
                <div class="play-button"><a class="popup-vimeo animated-circle" href="https://player.vimeo.com/video/54298665?color=ECCE52"><img class="img-fluid" src="../assets/images/home2/play-button.png" alt="play-button"></a></div>
              </div>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="home-right"><img class="img-fluid" data-tilt="" data-tilt-perspective="110" data-tilt-speed="400" data-tilt-max="1.2" src="../assets/images/home2/slider-caption.png" alt="slider-caption"></div>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-7 d-medium-none">
            <div class="about-right">
              <div class="about-phone"><img class="img-fluid" src="../assets/images/aboutus.png" alt="aboutus"></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <ul class="feature-style">
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/1.png" alt="icon"></div>
                  ...
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/3.png" alt="icon"></div>
                    <div class="feature-subtitle">
                  ...
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/5.png" alt="icon"></div>
                    <div class="feature-subtitle">
              ...
              <div class="col-12 col-md-6 sm-m-top">
                <ul class="feature-style">
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/2.png" alt="icon"></div>
                    <div class="feature-subtitle">
                      <h3>quick update</h3>
                    </div>
                    <div>
                  ...
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/4.png" alt="icon"></div>
                    <div class="feature-subtitle">
                      <h3>100% secure</h3>
                    </div>
                    <div>
                  ...
                  <li>
                    <div class="feature-icon"><img src="../assets/images/icon/6.png" alt="icon"></div>
                    <div class="feature-subtitle">
    ...
    <section class="screenshot padding-top-bottom" id="screenshot">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="screenshot-contain"><img class="mobile-light-left" src="../assets/images/light.png" alt="light"><img class="mob-mocup img-fluid" src="../assets/images/screenshot-mob.png" alt="screenshot-mob"><img class="mobile-light-right" src="../assets/images/light-right.png" alt="light-right">
              ...
              <div class="team-carousel owl-carousel owl-theme">
                <div class="team-item">
                  <div class="team-block">
                    <div class="team-box">
                      <div class="team-avtar"><img src="../assets/images/avtar/1.jpg" alt=""></div>
                      <div class="team-text">
                        <h3>mark jkcno</h3>
                        <h6>designer</h6>
                      </div>
                ...
                <div class="team-item">
                  <div class="team-block">
                    <div class="team-box">
                      <div class="team-avtar"><img src="../assets/images/avtar/15.jpg" alt=""></div>
                      <div class="team-text">
                        <h3>john doe</h3>
                        <h6>devloper</h6>
                      </div>
                ...
                <div class="team-item">
                  <div class="team-block">
                    <div class="team-box">
                      <div class="team-avtar"><img src="../assets/images/avtar/22.jpg" alt=""></div>
                      <div class="team-text">
                        <h3>johanson let</h3>
                        <h6>ux designer</h6>
                      </div>
    ...
    <!-- team Section End-->
    <!-- blog Section Start-->
    <section class="blog position-relative" id="blog">
      <div class="about-decor">
            ...
            <div class="blog-carousel owl-carousel owl-theme">
              <div class="blog-item">
                <div class="blog-block">
                  <div class="blog-box">
                    <div class="overflow-hidden"><a href="blog-details.html"><img src="../assets/images/blog/8.jpg" alt=""></a></div>
                  </div>
                </div>
                <div class="blog-text">
                  <h6>12 march 2015</h6><a href="blog-details.html">
                    <h3>The first line of Lorem Ipsum Lorem ipsum dolor sit amet comes from a line in section 1.10.32.</h3></a>
              ...
              <div class="blog-item">
                <div class="blog-block">
                  <div class="blog-box">
                    <div class="overflow-hidden"><a href="blog-details.html"><img src="../assets/images/blog/blog3.jpg" alt=""></a></div>
                  </div>
                </div>
                <div class="blog-text">
                  <h6>25 january 2018</h6><a href="blog-details.html">
                    <h3>There are many variations of passages of Lorem Ipsum available, </h3></a>
              ...
              <div class="blog-item">
                <div class="blog-block">
                  <div class="blog-box">
                    <div class="overflow-hidden"><a href="blog-details.html"><img src="../assets/images/blog/6.jpg" alt=""></a></div>
                  </div>
                </div>
                <div class="blog-text">
                  <h6>15 jun 2016</h6><a href="blog-details.html">
                    <h3>Lorem Ipsum has been the industry's standard dummy text </h3></a>
              ...
              <div class="blog-item">
                <div class="blog-block">
                  <div class="blog-box">
                    <div class="overflow-hidden"><a href="blog-details.html"><img src="../assets/images/blog/7.jpg" alt=""></a></div>
                  </div>
                </div>
                <div class="blog-text">
                  <h6>10 February 2012</h6><a href="blog-details.html">
                    <h3>All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary</h3></a>
              ...
              <div class="blog-item">
                <div class="blog-block">
                  <div class="blog-box">
                    <div class="overflow-hidden"><a href="blog-details.html"><img src="../assets/images/blog/9.jpg" alt=""></a></div>
                  </div>
                </div>
                <div class="blog-text">
                  <h6>28 December 2017</h6><a href="blog-details.html">
                    <h3>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested.</h3></a>
            ...
            <div class="price-carousel owl-carousel owl-theme">
              <div class="price-item">
                <div class="price-block">
                  ...
                  </ul><a class="btn btn-custom theme-color" href="#" role="button">Select Plane</a>
                </div>
              </div>
              <div class="price-item">
                <div class="price-block">
          ...
          <div class="col-md-12 col-lg-8 col-sm-12">
            <div class="contact-us">
              <div class="w-100">
                ...
                <form class="theme-form" id="myform" action="../assets/mailer.php" method="post">
...
<form action="https://pixelstrap.us19.list-manage.com/subscribe/post?u=5a128856334b598b395f1fc9b&amp;id=082f74cbda"  class="footer-form needs-validation" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank">
<div class="form-group">
...
<!--Subscribe section Ends-->
      ...
      <div class="container-fluid">
        <div class="bottom-section">
          <div class="row">
                ...
                <div>
                  <ul class="footer-style">
                    <li>
                      ...
                      <div class="footer-address"><a href="#">B-17 ABC Center,  Near Temple, USA  123456</a></div>
                    </li>
                    <li>
                      <div class="footer-icon"><img src="../assets/images/telephone.png" alt="telephone"></div>
                      <div class="footer-address"><a href="#">122-456-7890  /  124-789-5690</a></div>
                    </li>
                    <li>
                      <div class="footer-icon"><img src="../assets/images/fotter-email.png" alt="fotter-email"></div>
                      <div class="footer-address"><a href="#">support@compnay.com</a></div>
                    </li>
                    <li>
                      <div class="footer-icon"><img src="../assets/images/fax.png" alt=""></div>
                      <div class="footer-address"><a href="#">123-456  /  456-789</a></div>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-md-6 p-0">
              <iframe class="md-height" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d35391.48685150366!2d72.77537852898678!3d21.18930639680146!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1530610361925" allowfullscreen=""></iframe>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="fb-customerchat" attribution="setup_tool" page_id="2123438804574660" theme_color="#18e7d3" logged_in_greeting="Hi! Welcome to PixelStrap Themes  How can we help you?" logged_out_greeting="Hi! Welcome to PixelStrap Themes  How can we help you?"></div>
    <!-- facebook chat section end-->
    <!-- browser code--><!--[if lt IE 9]>
