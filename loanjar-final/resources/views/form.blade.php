<main>
    ...
    <div class="container" id="form-container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="application-form" class="form-horizontal theme-form" action="{{route('process', $countrycode="us") }}"
                ...
                <!-- EOF: Hidden Fields -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 input-container">
                            <input type="text" class="form-control" name="firstName" placeholder="First name" minlength="2" required data-validateregex="^[a-zA-Z ]+$" data-validateregexerrormessage="First name can not contain any character other than alphabets and spaces" />
                        </div>
                        <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
                            <div class="hidden label label-danger" role="alert"></div>
                        </div>
                    ...
                    <div class=" form-group">
                        ...
                        <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">
                            <div class="label label-info" role="alert">Leave blank if you do not have an employer</div>
                            <div class="hidden label label-danger" role="alert"></div>
                        </div>
{{--                        <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2">--}}
{{--                            <div class="hidden label label-danger" role="alert"></div>--}}
