        ...
        <div class="row">
          <div class="col-md-5">
            <div class="home-contain">
              <div><img class="caption-img" src="../assets/images/logoimage.png" alt="caption-img">
                <h4>Landing page for</h4>
                <h1>t<span class="f-bold">o</span>v<span class="f-bold">o</span><span class="f-bold f-color">app</span></h1>
                <p>Enhance your business ideas with Powerful, Responsive, Elegant TOVO Theme.</p><a href="#"><img class="store" src="../assets/images/appstore.png" alt="appstore"></a><a href="#"><img class="ms-10 store" src="../assets/images/play-store.png" alt="play-store"></a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 offset-md-1">
            <div class="home-right"><img class="img-fluid" data-tilt="" data-tilt-perspective="110" data-tilt-speed="400" data-tilt-max="1.2" src="../assets/images/mobile.png" alt="mobile"></div>
          </div>
        </div>
      </div>
    </section>
